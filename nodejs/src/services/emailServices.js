...
let sendSimpleEmail=async(dataSend)=>{
  ...
  let info = await transporter.sendMail({
    from: '"Hiếu Phạm 👻" <hieuminh2001s4@gmail.com>', // sender address
...
let formatEmailSendWhenAskPatientToConfirm = (dataSend) => {
  ...
  let getBodyHTMLEmailRemedy = (dataSend) => {
    ...
    if (dataSend.language === "vi") {
      ...
      <p>Bạn nhận được email này vì bạn đã hoàn tất quá trình khám bệnh tại "Đặt lịch khám Online". Dưới đây là thông tin hóa đơn</p>
      <p>Trân trọng!</p>
      `;
    }
    if (dataSend.language === "en") {
      ...
      <p>You are receiving this email because you have completed your medical examination at  "Đặt lịch khám Online". Below is the invoice information:</p>
      <p>Best regard!</p>
      `;
    }
    return mailDetail;
